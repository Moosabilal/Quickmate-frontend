...
import { 
  ...
  Briefcase, CreditCard, CheckCircle, XCircle, 
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6 text-white">
                <div>
                    <div className="flex items-center gap-3 mb-2">
                        ...
                        <span className={`px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wide border bg-white/20 backdrop-blur-sm border-white/30 text-white`}>
                            {booking.status}
                        </span>
                    </div>
